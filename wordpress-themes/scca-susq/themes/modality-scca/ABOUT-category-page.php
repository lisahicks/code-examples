<?php
/**
 * Template Name: ABOUT-category-page
 *
 * @package Modality
 */
...
get_header(); ?>
    ...
    <div>
    	<img src="http://www.scca-susq.com/images/category-image-about.jpg" width="100%" height="auto" alt="AX-category-page"/> 
	</div>
	<?php 
			get_template_part( 'getstarted', 'section' );
			get_template_part( 'about-maincat', 'title' );
			get_template_part( 'about', 'features' );

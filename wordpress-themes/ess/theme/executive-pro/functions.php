...
function sp_footer_creds_filter( $creds ) {
	$creds = '<span class="footer-text-left">[footer_copyright] All Rights Reserved</span> <span class="footer-text-middle"><a href="http://dev-ww.com/ess/">Essintial Enterprise Solutions</a>  &middot;  100 Sterling Parkway, Suite 307, Mechanicsburg, PA 17050</span> <span class="footer-text-right"><a href="http://dev-ww.com/ess/terms-conditions/" title="Terms and Conditions">Terms and Conditions</a></span>';
	return $creds;
}
...
//	} else { 
	if (has_post_thumbnail() && is_page() || is_home() || is_single_post ) {
...
<div style="display: none;" class="imageDiv">
	<img src="http://dev-ww.com/ess/wp-content/uploads/2016/11/innerpage_news.jpg" alt="" width="2048" height="144" />
</div>
<style>
